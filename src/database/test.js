...
Database.then(async (db) => {
  ...
  // Consultar as classes (aulas) de um determinado professor, e trazer seus dados
  ...
  // Consultar agendamentos disponíveis de acordo com dados preenchidos no formulário
